...
True link strength function  $\widetilde{A}$ can be into a particular generic form. Procedure of dimensionality reduction removes then nearly all free parameters from the reduced kink-strength fnction. When the link strength function is given the structure of link strength matrices and so of food webs is a reflection of the **distribution of trophic traits in niche space**. One can attempt to determine this distribution either from observed phenotypes or using food web topologies alone.
